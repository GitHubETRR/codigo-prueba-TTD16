...
int main(){
   ...
   unsigned int horas1, minutos1, segundos1; 
   unsigned int horas2, minutos2, segundos2;
   unsigned int total_segundos, total_minutos, total_horas;
   
   printf("Bienvenido al programa que sumas 2 tiempos \n");
   printf("Para comenzar ingrese el primer tiempo a sumar en horas, minutos y segundos:\n ");
   scanf("%d:%d:%d", &horas1, &minutos1, &segundos1);
   printf("Ingrese el segundo tiempo a sumar en horas, minutos y segundos:\n ");
