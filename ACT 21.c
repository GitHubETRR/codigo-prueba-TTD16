//21.	Dada una fecha en el formato DDMMAAAA y separarlo en Dia, Mes y Año utilizando operaciones aritméticas. 
...
int main(){
   ...
   printf("Bievenido al programa donde separamos DDMMAAAA en dia, mes y año \n);")
   printf("Para comenzar ingrese el valor de la fecha en formato DDMMAAAA:\n");
   scanf("%d", &fecha);
